...
namespace eval twapi {
    ...
    array set OBSOLETEidispatch_prototypes {}
...
proc twapi::OBSOLETE_comobj_wrapper {comobj clsid args} {
...
proc twapi::TBD_eventsink_callback {comobj dispidmap script dispid lcid flags params} {
...
twapi::class create ::twapi::Automation {
    ...
    method -default {} {
        return [::twapi::_convert_variant [$_proxy Invoke ""]]
    }

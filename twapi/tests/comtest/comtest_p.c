...
/* [helpstring][id][propget] */ HRESULT STDMETHODCALLTYPE ITwapiTest_get_IntSAProperty_Proxy( 
    ITwapiTest __RPC_FAR * This,
    /* [retval][out] */ SAFEARRAY __RPC_FAR * __RPC_FAR *saP)
{
CLIENT_CALL_RETURN _RetVal;
...
/* [helpstring][id] */ HRESULT STDMETHODCALLTYPE ITwapiTest_GetVariantType_Proxy( 
    ITwapiTest __RPC_FAR * This,
...
/* [helpstring][id] */ HRESULT STDMETHODCALLTYPE ITwapiTest_GetApplicationNames_Proxy( 
    ITwapiTest __RPC_FAR * This,
    /* [out][in] */ VARIANT __RPC_FAR *varPP)
{
CLIENT_CALL_RETURN _RetVal;
...
/* [helpstring][id] */ HRESULT STDMETHODCALLTYPE ITwapiTest_OpenDoc6_Proxy( 
    ITwapiTest __RPC_FAR * This,
    /* [in] */ BSTR FileName,
    /* [in] */ long Type,
    /* [in] */ long Options,
    /* [in] */ BSTR Configuration,
    /* [out][in] */ long __RPC_FAR *Errors,
    /* [out][in] */ long __RPC_FAR *Warnings,
...
CLIENT_CALL_RETURN _RetVal;
    ...
    _RetVal = NdrClientCall2(
                  ...
                  ( unsigned char __RPC_FAR * )&Errors,
                  ( unsigned char __RPC_FAR * )&Warnings,
...
/* [helpstring][id] */ HRESULT STDMETHODCALLTYPE ITwapiTest_JMPSetDataVector_Proxy( 
    ITwapiTest __RPC_FAR * This,
    /* [in] */ VARIANT vec,
    /* [retval][out] */ int __RPC_FAR *pVT)
{
CLIENT_CALL_RETURN _RetVal;
    ...
    _RetVal = NdrClientCall2(
                  ...
                  (PFORMAT_STRING) &__MIDL_ProcFormatString.Format[932],
                  ( unsigned char __RPC_FAR * )&This,
                  ( unsigned char __RPC_FAR * )&vec,
                  ( unsigned char __RPC_FAR * )&pVT);
#else
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&Object_StubDesc,
                  (PFORMAT_STRING) &__MIDL_ProcFormatString.Format[932],
...
CINTERFACE_PROXY_VTABLE(40) _ITwapiTestProxyVtbl = 
{
    ...
    ITwapiTest_get_IntSAProperty_Proxy ,
    ITwapiTest_put_IntSAProperty_Proxy ,
    ITwapiTest_GetVariantType_Proxy ,
    ITwapiTest_GetApplicationNames_Proxy ,
    ITwapiTest_OpenDoc6_Proxy ,
    ITwapiTest_JMPSetDataVector_Proxy
};
...
/* 770 */	0x5,		/* Oi2 Flags:  srv must size, has return, */
			0x2,		/* 2 */

	/* Parameter saP */

/* 772 */	NdrFcShort( 0x113 ),	/* Flags:  must size, must free, out, simple ref, */
#ifndef _ALPHA_
/* 774 */	NdrFcShort( 0x4 ),	/* x86, MIPS, PPC Stack size/offset = 4 */
#else
			NdrFcShort( 0x8 ),	/* Alpha Stack size/offset = 8 */
#endif
/* 776 */	NdrFcShort( 0x418 ),	/* Type Offset=1048 */
...
/* 856 */	NdrFcShort( 0x11b ),	/* Flags:  must size, must free, in, out, simple ref, */
#ifndef _ALPHA_
/* 858 */	NdrFcShort( 0x4 ),	/* x86, MIPS, PPC Stack size/offset = 4 */
#else
			NdrFcShort( 0x8 ),	/* Alpha Stack size/offset = 8 */
#endif
/* 860 */	NdrFcShort( 0x3f8 ),	/* Type Offset=1016 */
...
#ifndef _ALPHA_
/* 876 */	NdrFcShort( 0x24 ),	/* x86, MIPS, PPC Stack size/offset = 36 */
#else
...
/* 886 */	NdrFcShort( 0x4 ),	/* x86, MIPS, PPC Stack size/offset = 4 */
			...
			NdrFcShort( 0x8 ),	/* Alpha Stack size/offset = 8 */
#endif
/* 888 */	NdrFcShort( 0x46 ),	/* Type Offset=70 */
...
/* 908 */	NdrFcShort( 0x158 ),	/* Flags:  in, out, base type, simple ref, */
#ifndef _ALPHA_
...
/* 914 */	NdrFcShort( 0x158 ),	/* Flags:  in, out, base type, simple ref, */
#ifndef _ALPHA_
...
#ifndef _ALPHA_
/* 922 */	NdrFcShort( 0x1c ),	/* x86, MIPS, PPC Stack size/offset = 28 */
#else
...
/* 950 */	NdrFcShort( 0x4 ),	/* x86 Stack size/offset = 4 */
			...
			NdrFcShort( 0x8 ),	/* Alpha Stack size/offset = 8 */
#endif
/* 952 */	NdrFcShort( 0x406 ),	/* Type Offset=1030 */
...
/* 1076 */	
			0x11, 0x0,	/* FC_RP */
/* 1078 */	NdrFcShort( 0xffffffc2 ),	/* Offset= -62 (1016) */
/* 1080 */	

...
#+TITLE:     Tcl on Windows FAQ (2019-12-05)
...
** Where can I find documentation for Tcl?
   The reference documentation for Tcl 8.6 is available at
   http://www.tcl-lang.org/man/tcl8.6/. A standalone
   Windows CHM help file containing documentation for Tcl/Tk and several
   extensions is available from the [[#twapi][=TWAPI=]] download area.
   
   The [[http://www.tcl-lang.org/doc/][Tcl web site]] lists several books
   on Tcl/Tk. In addition, there is an 
   [[https://www.magicsplat.com/book/index.html][online]] book
   specific to programming with Tcl on Windows.
...
** What Tcl distributions are available for Windows?
   ...
   See the [[http://www.tcl-lang.org/software/tcltk/bindist.html][Binary Distributions]]
   page.

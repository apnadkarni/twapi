...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
// Provider "Twapi-App" event count 5
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++

// Provider GUID = 806a7a75-0f8b-4bb7-b57b-24ba13c6d626
EXTERN_C __declspec(selectany) const GUID TWAPI_EVT_PROVIDER = {0x806a7a75, 0x0f8b, 0x4bb7, {0xb5, 0x7b, 0x24, 0xba, 0x13, 0xc6, 0xd6, 0x26}};

#ifndef TWAPI_EVT_PROVIDER_Traits
#define TWAPI_EVT_PROVIDER_Traits NULL
#endif // TWAPI_EVT_PROVIDER_Traits

//
// Channel
//
#define TWAPI_EVT_CHANNEL_OPERATIONAL 0x10
#define TWAPI_EVT_CHANNEL_OPERATIONAL_KEYWORD 0x8000000000000000

//
// Tasks
//
#define TWAPI_EVT_TASK_LOGMESSAGE 0x1

//
// Event Descriptors
//
EXTERN_C __declspec(selectany) const EVENT_DESCRIPTOR TWAPI_EVT_EVENT_CRITICAL = {0x3e9, 0x0, 0x10, 0x1, 0x0, 0x1, 0x8000000000000000};
#define TWAPI_EVT_EVENT_CRITICAL_value 0x3e9
EXTERN_C __declspec(selectany) const EVENT_DESCRIPTOR TWAPI_EVT_EVENT_ERROR = {0x3ea, 0x0, 0x10, 0x2, 0x0, 0x1, 0x8000000000000000};
#define TWAPI_EVT_EVENT_ERROR_value 0x3ea
EXTERN_C __declspec(selectany) const EVENT_DESCRIPTOR TWAPI_EVT_EVENT_WARNING = {0x3eb, 0x0, 0x10, 0x3, 0x0, 0x1, 0x8000000000000000};
#define TWAPI_EVT_EVENT_WARNING_value 0x3eb
EXTERN_C __declspec(selectany) const EVENT_DESCRIPTOR TWAPI_EVT_EVENT_INFORMATIONAL = {0x3ec, 0x0, 0x10, 0x4, 0x0, 0x1, 0x8000000000000000};
#define TWAPI_EVT_EVENT_INFORMATIONAL_value 0x3ec
EXTERN_C __declspec(selectany) const EVENT_DESCRIPTOR TWAPI_EVT_EVENT_VERBOSE = {0x3ed, 0x0, 0x10, 0x5, 0x0, 0x1, 0x8000000000000000};
#define TWAPI_EVT_EVENT_VERBOSE_value 0x3ed
...
//
EXTERN_C __declspec(selectany) DECLSPEC_CACHEALIGN ULONG Twapi_AppEnableBits[1];
EXTERN_C __declspec(selectany) const ULONGLONG Twapi_AppKeywords[5] = {0x8000000000000000, 0x8000000000000000, 0x8000000000000000, 0x8000000000000000, 0x8000000000000000};
EXTERN_C __declspec(selectany) const unsigned char Twapi_AppLevels[5] = {1, 2, 3, 4, 5};

//
// Provider context
//
EXTERN_C __declspec(selectany) MCGEN_TRACE_CONTEXT TWAPI_EVT_PROVIDER_Context = {0, (ULONG_PTR)TWAPI_EVT_PROVIDER_Traits, 0, 0, 0, 0, 0, 0, 5, Twapi_AppEnableBits, Twapi_AppKeywords, Twapi_AppLevels};

//
// Provider REGHANDLE
//
#define Twapi_AppHandle (TWAPI_EVT_PROVIDER_Context.RegistrationHandle)
...
//
#define TWAPI_EVT_PROVIDER_EventWriteActivity 0
...
//
#ifndef EventRegisterTwapi_App
#define EventRegisterTwapi_App() McGenEventRegister(&TWAPI_EVT_PROVIDER, McGenControlCallbackV2, &TWAPI_EVT_PROVIDER_Context, &Twapi_AppHandle)
#endif
...
//
#ifndef EventRegisterByGuidTwapi_App
#define EventRegisterByGuidTwapi_App(Guid) McGenEventRegister(&(Guid), McGenControlCallbackV2, &TWAPI_EVT_PROVIDER_Context, &Twapi_AppHandle)
#endif
...
//
#ifndef EventUnregisterTwapi_App
#define EventUnregisterTwapi_App() McGenEventUnregister(&Twapi_AppHandle)
#endif
...
// - Caller allocates memory, e.g. pContext = malloc(sizeof(McGenContext_Twapi_App));
// - Caller registers the provider, e.g. EventRegisterTwapi_App_ForContext(pContext);
// - Caller writes events, e.g. EventWriteMyEvent_ForContext(pContext, ...);
// - Caller unregisters, e.g. EventUnregisterTwapi_App_ForContext(pContext);
// - Caller frees memory, e.g. free(pContext);
//

typedef struct tagMcGenContext_Twapi_App {
    // The fields of this structure are subject to change and should
    // not be accessed directly. To access the provider's REGHANDLE,
    // use Twapi_AppHandle_ForContext(pContext).
    MCGEN_TRACE_CONTEXT Context;
    ULONG EnableBits[1];
} McGenContext_Twapi_App;

#define EventRegisterTwapi_App_ForContext(pContext)             _mcgen_PASTE2(_mcgen_RegisterForContext_Twapi_App_, MCGEN_EVENTREGISTER)(&TWAPI_EVT_PROVIDER, pContext)
#define EventRegisterByGuidTwapi_App_ForContext(Guid, pContext) _mcgen_PASTE2(_mcgen_RegisterForContext_Twapi_App_, MCGEN_EVENTREGISTER)(&(Guid), pContext)
#define EventUnregisterTwapi_App_ForContext(pContext)           McGenEventUnregister(&(pContext)->Context.RegistrationHandle)

//
// Provider REGHANDLE for caller-allocated context.
//
#define Twapi_AppHandle_ForContext(pContext) ((pContext)->Context.RegistrationHandle)

// This function is for use by MC-generated code and should not be used directly.
// Initialize and register the caller-allocated context.
__inline
ULONG __stdcall
_mcgen_PASTE2(_mcgen_RegisterForContext_Twapi_App_, MCGEN_EVENTREGISTER)(
    _In_ LPCGUID pProviderId,
    _Out_ McGenContext_Twapi_App* pContext)
{
    RtlZeroMemory(pContext, sizeof(*pContext));
    pContext->Context.Logger = (ULONG_PTR)TWAPI_EVT_PROVIDER_Traits;
    pContext->Context.EnableBitsCount = 5;
    pContext->Context.EnableBitMask = pContext->EnableBits;
    pContext->Context.EnableKeyWords = Twapi_AppKeywords;
    pContext->Context.EnableLevel = Twapi_AppLevels;
...
FORCEINLINE
_Ret_ McGenContext_Twapi_App*
_mcgen_CheckContextType_Twapi_App(_In_ McGenContext_Twapi_App* pContext)
{
    return pContext;
}
...
//
// Enablement check macro for event "TWAPI_EVT_EVENT_CRITICAL"
//
#define EventEnabledTWAPI_EVT_EVENT_CRITICAL() _mcgen_EVENT_BIT_SET(Twapi_AppEnableBits, 0)
#define EventEnabledTWAPI_EVT_EVENT_CRITICAL_ForContext(pContext) _mcgen_EVENT_BIT_SET(_mcgen_CheckContextType_Twapi_App(pContext)->EnableBits, 0)
...
//
#define EventEnabledTWAPI_EVT_EVENT_ERROR() _mcgen_EVENT_BIT_SET(Twapi_AppEnableBits, 1)
#define EventEnabledTWAPI_EVT_EVENT_ERROR_ForContext(pContext) _mcgen_EVENT_BIT_SET(_mcgen_CheckContextType_Twapi_App(pContext)->EnableBits, 1)
...
//
#define EventEnabledTWAPI_EVT_EVENT_WARNING() _mcgen_EVENT_BIT_SET(Twapi_AppEnableBits, 2)
#define EventEnabledTWAPI_EVT_EVENT_WARNING_ForContext(pContext) _mcgen_EVENT_BIT_SET(_mcgen_CheckContextType_Twapi_App(pContext)->EnableBits, 2)
...
//
#define EventEnabledTWAPI_EVT_EVENT_INFORMATIONAL() _mcgen_EVENT_BIT_SET(Twapi_AppEnableBits, 3)
#define EventEnabledTWAPI_EVT_EVENT_INFORMATIONAL_ForContext(pContext) _mcgen_EVENT_BIT_SET(_mcgen_CheckContextType_Twapi_App(pContext)->EnableBits, 3)
...
//
#define EventEnabledTWAPI_EVT_EVENT_VERBOSE() _mcgen_EVENT_BIT_SET(Twapi_AppEnableBits, 4)
#define EventEnabledTWAPI_EVT_EVENT_VERBOSE_ForContext(pContext) _mcgen_EVENT_BIT_SET(_mcgen_CheckContextType_Twapi_App(pContext)->EnableBits, 4)
...
#define MSG_Twapi_TaskLogMessage             0x70000001L
#define MSG_Twapi_ProviderMessage            0x90000001L
#define MSG_Twapi_ChannelOperationalMessage  0x90000002L
#define MSG_Twapi_Event_Body                 0xB00003E9L
